 ...
 */
public class RemoveContributionItem extends ContributionItem {
	 ...
	 */
	public RemoveContributionItem(IViewSite viewSite, IHandler handler) {
	...
	public void fill(ToolBar parent, int index) {
		...
		toolItem.setToolTipText("Remove the selected items");
	...
	private void updateEnablement() {
		Image image = PlatformUI.getWorkbench().getSharedImages().getImage(enabled ? ISharedImages.IMG_TOOL_DELETE : ISharedImages.IMG_TOOL_DELETE_DISABLED);
		if (menuItem != null) {
