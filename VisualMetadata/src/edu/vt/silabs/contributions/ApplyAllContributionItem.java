 ...
 * @since JDK1.6
 */
public class ApplyAllContributionItem extends ContributionItem {
	...
	public ApplyAllContributionItem(IViewSite viewSite, IHandler handler) {
	...
	private void updateEnablement() {
		Image image = PlatformUI.getWorkbench().getSharedImages().getImage(enabled ? ISharedImages.IMG_TOOL_FORWARD_HOVER : ISharedImages.IMG_TOOL_NEW_WIZARD);
		if (menuItem != null) {
